...
import com.trippy.service.driverService.DriverService;
...
public class DriverController {
	...
	@PutMapping("/drivers")
	public ResponseEntity<Driver> updateDriver(@Valid @RequestBody Driver driver,@RequestParam(required = false) String key) throws DriverException{
		
		Driver updatedDriver = dServe.updateDriver(driver,key);
