...
public class DriverController {
	...
	@PostMapping("/drivers")
	public ResponseEntity<String> registerDriver(@Valid @RequestBody Driver driver) throws DriverException{
		
		System.out.println(driver);
		System.out.println("controleer");
		Driver addedDriver = dServe.insertDriver(driver);
		
		return new ResponseEntity<String>(addedDriver.toString(),HttpStatus.CREATED); 
